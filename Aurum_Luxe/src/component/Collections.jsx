...
const Collections = () => {
    return (
        <div className='w-full h-full lg:mb-30  p-10 py-20 lg:p-20 overflow-hidden  bg-cream09'>
            <div className='flex flex-col h-full md:flex-row my-20 items-start md:items-center justify-between'>
            ...
            <div className="gallery h-full w-full ">
                ...
                <div className='flex h-full md:flex-row flex-col gap-8'>
                    <div className="md:w-1/2 h-120 overflow-hidden rounded-lg">
                        <img
                    ...
                    <div className='w-full h-120 overflow-hidden rounded-lg '>
                        <img
                            className="img-transform rounded-lg"
                ...
                <div className='flex my-8 h-full md:flex-row flex-col gap-8 md:justify-evenly '>
                    <div className='w-full h-120 md:m-4 overflow-hidden rounded-lg '>
                        <img
                            className="img-transform"
                    ...
                    <div className='md:m-4 w-full h-120 overflow-hidden rounded-lg '>
                        <img
                            className="img-transform "
