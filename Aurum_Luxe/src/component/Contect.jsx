...
const Contect = () => {
    return (
        <div className='w-full h-full flex md:flex-row flex-col items-center bg-ivory19 p-6 md:p-10 py-28 '>
            <div className='p-6 w-1/2 w-full'>
            ...
            <div className='md:p-10  md:w-1/2 w-full'>
                ...
                <form action="" className='p-12 w-full h-full gap-10 bg-cream09 flex flex-col w-full h-full'>
