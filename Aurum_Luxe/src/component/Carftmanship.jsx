...
const Carftmanship = () => {
    return (
        <div className='w-full h-full overflow-hidden bg-ivory19 flex md:flex-row flex-col-reverse p-2 md:p-20 py-40 justify-evenly items-center'>
            <div className='md:w-1/2 lg:w-1/3 m-4 '>
